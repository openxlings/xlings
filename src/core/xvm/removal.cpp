module xlings.core.xvm.removal;
...
apply_removal_batch(VersionDB& db, Workspace& workspace, WorkspaceInstalled& installed, const std::vector<RemovalOperation>& operations, const RemovalContext& context, const RemovalBatchOptions& options) {
