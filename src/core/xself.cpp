...
module xlings.core.xself;

import std;
import xlings.core.xself.init;
import xlings.core.xself.install;
import xlings.core.xself.uninstall;
import xlings.core.xself.update;
import xlings.core.xself.config;
import xlings.core.xself.clean;
import xlings.core.xself.migrate;
import xlings.core.xself.doctor;
...
int cmd_help(EventStream& stream) {
