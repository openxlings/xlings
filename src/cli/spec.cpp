        ...
        .children = {
            ...
            {"remove", "Remove a package", {}, {{"package", "Package name", true}, {"version", "Optional version", false}},
                {{"-g, --global", "Use global scope"},
                 ...
                 {"--all", "Remove every installed version, not just the active one"},
                 {"--all-subos", "Remove from every subos that has it installed"},
                 {"--subos <NAME>", "Act on this subos only, instead of the current one"}}, {}},
