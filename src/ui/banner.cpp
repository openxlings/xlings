...
void print_subcommand_help(std::string_view name, std::string_view description, std::span<const HelpArg> args, std::span<const HelpOpt> opts, std::span<const HelpOpt> subcmds) {
    using namespace ftxui;
